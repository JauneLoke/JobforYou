...
$(document).ready(function() {
    ...
    $('.job-filter a, .candidate-filter a, .employer-filter a').on('click', function(e) {
      ...
      var filteredList = '<li class="' + cls + '">' + innerContent + '<input type="hidden" name="'+cls+'[]" value="'+$(this).data("id")+'"/></li>';
    ...
    $('.job-filter a, .candidate-filter a, .employer-filter a').each(function(k, v) {
        if($(v).data('selected') == true) {
            $(v).click();
        }
    });
